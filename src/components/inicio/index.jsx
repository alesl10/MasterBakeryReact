  ...
  return (
    <>
      <section id="Inicio"
        ...
        <h3 className="text-[1.7rem] sm:text-[3rem] md:text-[3.5rem] xl:text-[4rem] text-orange-400 underline sm:no-underline sm:text-white font-semibold ">
        ...
        <a className="hover:text-gray-800 hover:bg-orange-400 rounded-md border-solid border-4 px-1 mt-3 border-yellow-200 bg-white bg-opacity-25 gap-10 text-white  font-bold text-[1.3rem] sm:text-3xl"
          href="./PRODUCTOS.pdf" download="Productos.pdf">Descargar lista de productos</a>
