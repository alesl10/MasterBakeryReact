                ...
                <div className="bg-orange-400/40 p-4 flex flex-col gap-5">
                    ...
                    <Carousel responsive={responsive}>
                        <div className=' flex flex-col justify-center items-center text-white text-xl font-medium'>
                            ...
                            <img src="./images/productos/Muffinschocolate.jpg" className=' w-[20rem]' alt="imagen producto" />
                            <p>Descripcion producto</p>
                            <p>Stock permanente</p>
                        </div>
                        <div className=' flex flex-col justify-center items-center text-white text-xl font-medium'>
                            <h4>Titulo producto</h4>
                            <img src="./images/productos/Pandequeso.jpg" className=' w-[20rem]' alt="imagen producto" />
                            <p>Descripcion producto</p>
                            <p>Stock permanente</p>
                        </div>
                        <div className=' flex flex-col justify-center items-center text-white text-xl font-medium'>
                            <h4>Titulo producto</h4>
                            <img src="./images/productos/PolvoparaHornear.jpg" className=' w-[20rem]' alt="imagen producto" />
                            <p>Descripcion producto</p>
                            <p>Stock permanente</p>
                        </div>
                        <div className=' flex flex-col justify-center items-center text-white text-xl font-medium'>
                            <h4>Titulo producto</h4>
                            <img src="./images/productos/Muffinsdevainilla.jpg" className=' w-[20rem]' alt="imagen producto" />
                            <p>Descripcion producto</p>
                            <p>Stock permanente</p>
                        </div>
                        <div className=' flex flex-col justify-center items-center text-white text-xl font-medium'>
                            <h4>Titulo producto</h4>
                            <img src="./images/productos/Muffinsdevainilla.jpg" className=' w-[20rem]' alt="" />
                            <p>Descripcion producto</p>
                            <p>Stock permanente</p>
                        </div>
                        <div className=' flex flex-col justify-center items-center text-white text-xl font-medium'>
