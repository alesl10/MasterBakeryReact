            ...
            <nav className=" relative select-none bg-orange-300/80 lg:flex lg:items-stretch w-full">
                <div className="flex flex-no-shrink items-stretch h-12">
                    ...
                    <button className="block lg:hidden cursor-pointer ml-auto relative w-12 h-12 p-4">
                        <svg id="abrir" onClick={() =>Abrir()} className="fill-current text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M0 3h20v2H0V3zm0 6h20v2H0V9zm0 6h20v2H0v-2z" /></svg>
