                ...
                <div class="lg:flex lg:items-stretch lg:flex-no-shrink lg:flex-grow">
                    <div class="lg:flex lg:items-stretch lg:justify-end ml-auto">
                        {categories.map(category => (
                            <li key={category} onClick={() => filterCategoriy(category)} className=" cursor-pointer flex-no-grow flex-no-shrink relative py-2 px-4 leading-normal text-white no-underline flex items-center hover:bg-grey-dark">{category}</li>
                        ))}
                    </div>
                </div>
            </nav>
